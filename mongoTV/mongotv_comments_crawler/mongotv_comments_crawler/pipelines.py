...
class MongotvCommentsCrawlerPipeline(object):
    ...
    @classmethod
    def from_crawler(cls, crawler):  # 定义类方法，提取出mongodb配置
        return cls(
    ...
    def open_spider(self, spider):
        ...
        self.db['mongotv1'].ensure_index('comment_id', unique=True)  # 在集合"mongotv1"中建立索引，并保证索引的唯一性
    ...
    def process_item(self, item, spider):
        try:
            self.db['mongotv1'].update({'comment_id': item['comment_id']}, {'$set': item}, upsert=True)
